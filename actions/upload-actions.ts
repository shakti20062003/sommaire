...
//           summary = pdfText; // fallback
//           console.log("Falling back to raw PDF text as summary.");
//         }
//       } else {
//         // If OpenAI failed but not due to rate limit
//         summary = pdfText; // fallback
//         console.log(
//           "OpenAI failed for other reason — using PDF text as summary.",
//         );
//       }
//     }
...
//     // Save summary in DB (including fallback case)
...
//     // Step 2: If not exists, insert placeholder user
