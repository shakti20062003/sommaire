...
const TimeAgoClient = dynamic(() => import("./TimeAgoClient"), {
  ssr: false,
});
...
export default function SummaryCard({ summary }: { summary: any }) {
  ...
  return (
    <div>
      <Card className="relative h-full rounded-xl border border-gray-200 transition-all hover:shadow-md hover:bg-gray-50">
